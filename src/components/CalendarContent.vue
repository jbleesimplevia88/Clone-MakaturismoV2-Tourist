<template>
  ...
  <div
    ...
    <!-- <router-link to="/calendar"> -->
    <button
      class="flex items-center justify-center px-5 py-2  text-white bg-[#2969D6] rounded-lg shadow-gray-500/50">View
      All</button>
    <!-- </router-link> -->
  </div>
</template>
...
<script scoped>
import CalendarMonthCarousel from '@/components/CalendarMonthCarousel.vue';
import CalendarPastCarousel from '@/components/CalendarPastCarousel.vue';
