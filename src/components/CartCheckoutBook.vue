<template>
  <div class="w-screen">
    <nav
      class=" w-[100%] h-28 pt-16 pl-5  bg-[#132540] text-white text-xl font-semibold flex items-center  cursor-pointer lg:px-[100px] lg:h-20 lg:mt-[80px] lg:text-4xl lg:pt-0 ">
    ...
    <transition :name="showPayment ? 'fade' : 'slide-up'" @after-enter="scrollToTop">
      <div v-if="showPayment">
        <div class="justify-center my-5 mr-5 relative lg:mb-[10rem] ">
          <div class="hidden lg:block relative lg:w-[60%] lg:top-[3rem] top-5">
          ...
          <div class=" lg:hidden p-5 ">
            <p class=" text-2xl font-bold">Your Trip</p>
            <div className="grid grid-cols-2 grid-rows-3 gap-4 pt-5">
              <div>
                <p class=" text-base font-semibold">Date of Tour</p>
              </div>
              <div>
                <p class="font-normal mb-2  text-base ">07/24/2023</p>
              </div>
              <div>
                <p class=" text-base font-semibold">Time of Tour</p>
              </div>
              <div>
                <p class="font-normal mb-2  text-base ">1:00 PM - 3:00 PM</p>
              </div>
              <div>
                <p class=" text-base font-semibold">Number of Person</p>
              </div>
              <div>
                <p class="font-normal mb-2  text-base ">3</p>
              </div>
            </div>
            <p class="text-base font-semibold">Services Included</p>
            <p class="font-normal mb-2 overflow-hidden whitespace-nowrap text-base" style="text-overflow: ellipsis;">
              &#8226; Service 1</p>
          ...
          <div class="my-4 lg:w-[32%] lg:h-[30%] lg:right-10 lg:absolute relative lg:top-[3rem] w-screen">
            <div class="border border-gray-400 rounded-xl p-5 ml-5 w-[90%]  h-fit">
              <div class="lg:flex items-center mb-5">
                <img src="@/assets/images/CategoryView/ToStay/xyz.png"
                  class="lg:w-[50%] w-[100%] h-32 rounded-lg object-cover">
                <div class="lg:ml-3 lg:flex lg:flex-col pt-4">
                  <div>
                    <p class="font-bold  text-base pb-2">XYZ Hotel</p>
                    <p class="text-gray-400 text-base ">Hotel</p>
                  </div>
                  <div class="flex pt-4">
                    <p class="font-bold text-base  mr-1 ">5.0 Ratings</p>
                    <p class="text-base  text-gray-400">(500 Review)</p>
                  </div>
                </div>
              </div>
              ...
              <div class="items-center mb-5">
                <div class="flex justify-between mb-2 lg:w-[100%]">
                  <p class="w-[70%] text-base  pt-4">1 Tour Session
                  </p>
                  <p class="text-gray-400 text-base pt-4 lg:hidden ">₱ 30.00</p>
                  <p class="text-gray-400 text-base pt-4 lg:block hidden">Free</p>
                </div>
              </div>
              <div class="bg-gray-400 h-0.5 w-[100%]"></div>
              <div class="flex justify-between">
                <p class="font-poppins font-sans font-bold text-lg pt-4">Your Total (Php)</p>
                <p class="font-poppins font-sans text-base font-bold pt-4 lg:hidden ">₱ 30.00</p>
                <p class="font-poppins font-sans text-base font-bold pt-4 lg:block hidden ">Free</p>
              </div>
              <p class="font-poppins font-sans text-base font-bold text-right underline ">Price Breakdown
              </p>
              <!-- For Mobile -->
              ...
              <div v-if="showComplete"
                ...
                <div class="bg-white rounded-lg shadow-md p-2 lg:max-w-2xl h-2p-[20px]" @click.stop>
                  <div class="lg:w-[100%] p-4 rounded-lg text-center flex flex-col items-center">
                    ...
                    <router-link to="/category/stay"><button class="text-white h-16 w-60 bg-blue-500 rounded-xl py-5"
