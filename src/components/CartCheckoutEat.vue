                        ...
                        <div class="lg:block relative lg:w-[60%] lg:top-[3rem] top-5">
                            ...
                            <div class="relative hidden lg:block mx-6 px-3 lg:pl-32 mb-[30px] lg:mb-44">
                                ...
                                <div class="mt-2 flex border rounded p-4 h-24" @click="selectedPaymentMethod = 'ibayad'"
                                    ...
                                    <div class="ms-2 text-sm">
                                        <label for="payment_ibayad" class="font-semibold text-l text-gray-700">
        ...
        <div class="mt-[0rem] w-full h-full p-8">
            <div className="grid grid-cols-1 grid-rows-4 gap-0">
                <div class="flex border rounded p-8 h-24" @click="selectedPaymentMethod = 'gcash'" :class="{ 'bg-blue-100': selectedPaymentMethod === 'gcash' }">
                    <div class="flex items-center pr-3">
                        <input id="gcash" aria-describedby="helper-radio-text" type="radio" value="gcash" class="w-4 h-4 bg-gray-100 border-gray-300 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" v-model="selectedPaymentMethod">
                    </div>
                    <div class="ms-2 text-sm">
                        <label for="helper-radio" class="font-semibold text-xl text-gray-700">
                                            Ibayad</label>
                ...
                <div class="mt-2 flex border rounded p-4 h-24" @click="selectedPaymentMethod = 'ibayad'" :class="{ 'bg-blue-100': selectedPaymentMethod === 'ibayad' }">
                    <div class="flex items-center pr-3">
                        <input id="payment_ibayad" name="payment_method" value="ibayad" class="w-4 h-4 bg-gray-100 border-gray-300 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" v-model="selectedPaymentMethod">
                    </div>
                    <div class="ms-2 text-sm">
