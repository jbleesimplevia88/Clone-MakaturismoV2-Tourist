                        ...
                        <div class="lg:block relative lg:w-[60%] lg:top-[3rem] top-5">
                            <div class="relative mx-6 px-3 lg:pl-32 mb-[30px]">
                                ...
                                <div class="w-full">
                                    ...
                                    <div class="flex justify-between items-center">
                                        <p class="text-xs w-[40%]">Spicy Maguro</p>
                                        <p class="w-[15%] text-center">1</p>
                                        <p class="w-[15%] text-center">299</p>
                                        <p class="w-[15%] text-center">299</p>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <p class="text-xs w-[40%]">Takoyaki</p>
                                        <p class="w-[15%] text-center">1</p>
                                        <p class="w-[15%] text-center">150</p>
                                        <p class="w-[15%] text-center">150</p>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <p class="text-xs w-[40%]">Udon</p>
                                        <p class="w-[15%] text-center">1</p>
                                        <p class="w-[15%] text-center">249</p>
                                        <p class="w-[15%] text-center">249</p>
                                    </div>
                                    <div class="flex justify-between items-center">
                                        <p class="text-xs w-[40%]">Oyako Don</p>
                                        <p class="w-[15%] text-center">2</p>
                                        <p class="w-[15%] text-center">299</p>
                                        <p class="w-[15%] text-center">598</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="border border-gray-400 rounded-xl p-5 ml-5 w-[90%] h-fit">
                                ...
                                <div v-for="(food, index) in foodItems" :key="index">
                                    <div class="lg:flex items-center mb-5">
                                        <!-- Replace image source with dynamic data if available -->
                                        <img :src="food.image" class="w-[100%] lg:w-[40%] h-[6rem] rounded-lg">
                                        <div class="ml-1 flex flex-col">
                                            <div>
                                                <p class="font-bold">{{ food.name }}</p>
                                            </div>
                                            <div>
                                                <p class="mb-5 mt-2 text-gray-400">{{ food.type }}</p>
                                            </div>
                                            <div class="flex">
                                                <p class="font-semibold text-sm mt-0">{{ food.rating }} Ratings</p>
                                                <p class="text-sm text-gray-400">({{ food.reviews }} Review)</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="items-center mb-5">
                                        <div class="flex justify-between mb-2 w-[100%]" v-for="(item, i) in food.items"
                                            :key="i">
            ...
            <div className="grid grid-cols-1 grid-rows-4 gap-0">
                <div class="flex border rounded p-8 h-24" @click="activateRadioButton('gcash')">
                    <div class="flex items-center pr-3">
                        <input id="gcash" aria-describedby="helper-radio-text" type="radio" value="gcash" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                    </div>
...
<template v-else>
    <div class="lg:w-[100%] p-4 rounded-lg text-center flexflex-col items-center pt-20">
        ...
        <div class="flex flex-col items-center">
            <input type="text" id="" name="" value="" class="mb-2 h-[50px] w-[100%] border border-gray-200 pl-5 pr-3 rounded-md" placeholder="Enter Voucher Code">
            <button class="mb-2 text-white bg-blue-500 rounded-xl w-full lg:w-full py-2 lg:py-3 px-4 lg:px-6 text-base lg:text-lg font-semibold" @click="toggleVoucher">Apply</button>
            <div>
            ...
            totalPrice() {
                ...
                for (let item of this.foodItems) {
                    for (let food of item.items) {
                        ...
                        total += parseFloat(food.price.replace("₱", "").trim());
                    }
                }
