<template>
    ...
    <div class="lg:px-[180px] p-10 relative">
        ...
        <div class="flex justify-between">
                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-4 gap-4">
                        <div>
                            ...
                            <p class="font-normal mb-2 text-gray-400">Spicy Maguro</p>


                        </div>
                        <div>
                            <p class="lg:mr-9 mb-1 font-bold">Quantity</p>
                            <p class="font-normal mb-2 text-gray-400">1</p>
                        </div>
                        <div>
                            <p class="lg:mr-9 mb-1 font-bold">Cost</p>
                            <p class="font-normal mb-2 text-gray-400">299</p>
                        </div>
                        <div>
                        ...
                        <div>
                            <p class="font-normal mb-2 text-gray-400">Takoyaki</p>
                        ...
                        <div>
                            <p class="font-normal mb-2 text-gray-400">150</p>
                        ...
                        <div>
                            ...
                            <p class="font-normal mb-2 text-gray-400">Udon</p>
                        ...
                        <div>
                            ...
                            <p class="font-normal mb-2 text-gray-400">249</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p class="font-normal mb-2 text-gray-400">Oyako Don</p>


                        </div>
                        <div>
                            <p class="font-normal mb-2 text-gray-400">2</p>
                        </div>
                        <div>
            ...
            <div class="relative flex lg:h-[20%] lg:w-[30%]">

                <div class="border border-gray-200 mr-5 rounded-xl p-5">
                    <div class="flex items-center mb-5">
                        <img src="@/assets/images/CategoryView/ToEat/tokyo.png" class="w-[50%] rounded-lg">
