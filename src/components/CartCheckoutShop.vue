    ...
    <div class="w-full lg:mb-[22rem] ">
        ...
        <transition :name="showPayment ? 'fade' : 'slide-up'" @after-enter="scrollToTop">
            <div v-if="showPayment">
                <div class="justify-center my-5 mr-5 relative ">
                    <div class="lg:block relative lg:w-[60%] lg:top-[3rem] top-5">
                        <div class="relative mx-6 px-3 lg:pl-32 mb-[30px]">
                            ...
                            <div class="w-full">
                                ...
                                <div class="flex justify-between items-center">
                                    <p class="text-xs w-[40%]">Multi Handle Tote Bag with Embroidered Philippines Kalesa
                                        Scenery</p>
                                    <p class="w-[15%] text-center">1</p>
                                    <p class="w-[15%] text-center">399</p>
                                    <p class="w-[15%] text-center">399</p>
                                </div>

                                <div class="flex justify-between items-center">
                                    <p class="text-xs w-[40%]">Multi Handle Tote Bag with Embroidered Philippine Jeepney
                                        Kalesa Scenery</p>
                                    <p class="w-[15%] text-center">3</p>
                                    <p class="w-[15%] text-center">399</p>
                                    <p class="w-[15%] text-center">1197</p>
                                </div>

                                <div class="flex justify-between items-center">
                                    <p class="text-xs w-[40%]">Beat the Heat Graphic Tee in Blush Kalesa Scenery</p>
                                    <p class="w-[15%] text-center">1</p>
                                ...
                                <div class="flex justify-between items-center">
                                    <p class="text-xs w-[40%]">Never Stop Exploring Graphic Tee in Gray</p>
                                ...
                                <div class="flex justify-between items-center">
                                    <p class="text-xs w-[40%]">Ethnic Stripes Book Tote Bag Kalesa Scenery</p>
                                    <p class="w-[15%] text-center">2</p>
                                    <p class="w-[15%] text-center">700</p>
                                    <p class="w-[15%] text-center">1400</p>
                                </div>
                        ...
                        <div class="border border-gray-400 rounded-xl p-5 ml-5 w-[90%]  h-fit">
                            ...
                            <div class="flex  items-center my-7 ">
                                ...
                                <input type="text" id="" name="" value=""
                                    class="h-[50px] w-[70%] border border-gray-200 pl-5 mr-6"
                            ...
                            <div data-v-392f50c8="" class="bg-gray-400 h-0.5 w-[100%]"></div>


                            <div class="flex justify-between">
                                <p class="font-poppins font-sans font-bold text-lg pt-4 lg:hidden">Your Total (Php)</p>
                            ...
                            <p class="font-poppins font-sans text-base font-bold text-right underline hidden ">Price
                                Breakdown
                            </p>
                            <!-- For Mobile -->
