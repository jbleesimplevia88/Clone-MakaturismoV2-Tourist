    ...
    <div class="lg:px-[180px] p-10 relative">
        ...
        <div class="flex justify-between">
            <div class="lg:w-[60%]">
                ...
                <p class="mb-4 lg:font-bold lg:text-3xl">Your Information</p>
                ...
                <div class="">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <p class="lg:mr-9 mb-1 lg:font-bold">E-mail Address</p>
                            <p class="font-normal mb-2 text-gray-400">juandelecruz@gmail.com</p>
                        </div>
                        <div>
                            <p class="lg:mr-9 mb-1 lg:font-bold">Phone Number</p>
                            <p class="font-normal mb-2 text-gray-400">09569103856</p>
                        </div>
                        <div>
                            <p class="lg:mr-9 mb-1 lg:font-bold">Gender</p>
                            <p class="font-normal mb-2 text-gray-400">Male</p>
                        </div>
                        <div>
                            <p class="lg:mr-9 mb-1 lg:font-bold">Citizen of Makati</p>
                ...
                <div class="flex flex-col pt-6">
                    ...
                    <div class="">
                        <p class="font-bold lg:text-3xl mb-4">Payment</p>
            ...
            <div class="relative flex lg:w-[30%]">
                ...
                <div class="border border-gray-200 mr-5 rounded-xl p-5">
                    ...
                    <p class="mr-9 mt-2 lg:font-bold lg:text-3xl">Your Total</p>
                    ...
                    <div class="flex items-center my-7">
                        ...
                        <p class="font-poppins font-sans text-base text-blue-500 mr-4 lg:font-bold">Use Voucher</p>
                    ...
                    <div class="flex justify-between">
                        ...
                        <p class="font-poppins font-sans text-base font-bold lg:text-2xl">₱ 3,843.00</p>
                    </div>


                    <div class="flex justify-center mt-4">
                        <button class="text-white bg-blue-500 rounded-xl w-[100%] py-5"
                            @click="toggleInformation">Proceed to Payment</button>
                    </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md lg:max-w-2xl p-[20px]" @click.stop>
                            <div class="lg:w-[100%] p-4 rounded-lg">
                                ...
                                <div class="mb-5">
                                    ...
                                    <p class="mr-9 mt-2 font-bold font-sans  text-2xl">Your Total</p>
