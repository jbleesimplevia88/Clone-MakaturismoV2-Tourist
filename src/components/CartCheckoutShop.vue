                    ...
                    <div class="lg:block relative lg:w-[60%] lg:top-[3rem] top-5">
                        <div class="relative mx-6 px-3 lg:pl-32 mb-[30px]">
                            ...
                            <div class="w-[100%]">
                                ...
                                <div class="flex justify-between">
                                    <p class="text-xs w-[50%]">Multi Handle Tote Bag with Embroidered Philippines Kalesa
                                        Scenery</p>
                                ...
                                <div class="flex justify-between ">
                                    <p class="text-xs w-[50%]">Multi Handle Tote Bag with Embroidered Philippine Jeepney
                                        Kalesa
                                        Scenery
                                    </p>
                    ...
                    <div v-for="(shop, index) in shops" :key="index"
                        ...
                        <div class="border border-gray-400 rounded-xl p-5 ml-5 w-[90%] h-fit">
                            ...
                            <div class="items-center mb-5">
                                <!-- Your item list -->
                                <div v-for="(item, index) in shop.items" :key="index"
            ...
            shops: [
                {
                    ...
                    items: [
                        {
                            name: "Multi handed Tote Bag with embroidered Philippines Kalesa Scenery",
                            price: "₱ 399.00"
                        },
                        {
                            name: "Multi Handle Tote Bag With Embroidered Jeepney",
                            price: "₱ 1197.00"
                        },
                        {
                            name: "Beat the Heat Graphic Tee in Blush",
                            price: "₱ 249.00"
                        },
                        {
                            name: "Never Stop Exploring Graphic Tee in Gray",
                            price: "₱ 598.00"
                        },
                        {
                            name: "Ethnic Stripes Book Tote Bag",
                            price: "₱ 1400.00"
                        }
                    ]
                }
    ...
    computed: {
        totalPrice() {
            ...
            for (let item of this.shops) {
                for (let shop of item.items) {
                    // pang kuha ng price remove sign
                    total += parseFloat(shop.price.replace("₱", "").trim());
                }
            }
