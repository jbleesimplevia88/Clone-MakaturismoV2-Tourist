            ...
            <div class="lg:w-[60%]">
                ...
                <div class="">
                    ...
                    <div class="lg:grid lg:grid-cols-2 lg:gap-4">
                        ...
                        <div>
                            <p class="lg:mr-9 lg:mb-1 lg:font-bold">Other Request</p>
                            <p class="font-normal mb-2 text-gray-400 overflow-hidden whitespace-nowrap lg:overflow-visible lg:whitespace-normal"
            ...
            <div class="relative flex lg:h-[20%] lg:w-[30%]">
                ...
                <div class="border border-gray-200 mr-5 rounded-xl p-5">
                    <div class="flex items-center mb-5">
                        <img src="@/assets/images/CategoryView/ToTour/tour.png" class="w-[50%] rounded-lg">
                        <div class="ml-1 flex flex-col">
                            <div>
                                <p class="font-bold">Central Business <br> District Tour</p>
                            </div>
                            <br>
                            <div>
                                <p class="mb-8 text-gray-400">Guided Tour</p>
                            </div>
                            <div class="flex">
                    ...
                    <p class="mr-9 mt-2 font-bold font-sans  lg:text-3xl">Your Total</p>

                    <div class="items-center mb-5">
                        <div class="flex justify-between mb-2 w-[100%]">
                            <p class="w-[70%]">1 Tour Session
                            </p>
                    ...
                    <div class="flex justify-between">
                        ...
                        <p class="font-poppins font-sans text-base font-bold">Free</p>
                    </div>
