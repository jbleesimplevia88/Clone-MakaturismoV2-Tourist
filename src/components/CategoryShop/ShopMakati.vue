            ...
            <div class="relative mx-6 px-3 lg:px-32 pt-5">
                ...
                <div class="my-4 lg:w-[100%]">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 justify-start text-white lg:w-[70%]">
                        ...
                        <div v-for="(item, index) in bestProducts" :key="index" class=" lg:w-auto lg:flex-auto bg-blue-950 lg:h-[15rem] h-[190px] m-1 p-2 lg:p-3 rounded-xl relative flex flex-col justify-between">
