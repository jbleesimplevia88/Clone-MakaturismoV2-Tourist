                ...
                <div class="relative flex flex-col pl-0 lg:pl-10">
                    ...
                    <div class="relative flex flex-col items-center justify-between">
                        <div class="lg:pl-9 grid grid-cols-1 lg:grid-cols-5 ">
                            <img src="@/assets/images/CategoryView/ToShop/shop1.png" alt="" class="col-span-3 w-[100%] h-full lg:w-[100%] lg:h-[95%] rounded-l-3xl">
                            ...
                            <div v-for="(item, index) in otherProducts.slice(0, 3)" :key="index" class="card-wrapper">
                                ...
                                <div class="card bg-blue-950 w-[100%] border-2 h-[190px] m-1 p-4 rounded-xl relative flex justify-between">
                                    <div class="flex justify-between w-[100%]">
                                        ...
                                        <div class="w-[60%]">
                                            <p class="grid grid-cols-1 text-xs text-white mb-4 ml-2"> {{item.title}} </p>
                        ...
                        <div class="lg:w-[100%] p-4 rounded-lg">
                                    ...
                                    <div class=" flex flex-col text-black mb-3">
                                        ...
                                        <div class="lg:inline-flex hidden items-center justify-between" style="line-height: 2;">
                                            ...
                                            <div class="flex items-center">
                                                <p>Quantity</p>
                                                <button @click="increaseQuantity" class="ml-4 px-4 py-1 bg-gray-200 text-gray-700 rounded-l-lg">+</button>
                                                <span class="px-4">{{ selectedProduct.quantity }}</span>
                                                <button @click="decreaseQuantity" class="px-4 py-1 bg-gray-200 text-gray-700 rounded-r-lg">-</button>
                                            </div>
                                        </div>
                            ...
                            <div class="lg:hidden flex items-center text-black mb-4">
                                ...
                                <!-- <button @click="decreaseQuantity"
                                    ...
                                    <span v-if="selectedProduct && selectedProduct.quantity">{{ selectedProduct.quantity
                                    }}</span>
                ...
                <div class="cart-bg my-4 lg:w-[30%] lg:h-[85rem] right-7 absolute top-[8rem] ">
                    <div class="cart-list lg:w-[75%] h-[40rem] border border-gray-300 p-4 rounded-lg shadow">
                        ...
                        <div>
                            ...
                            <button @click="handleCheckCart" class="text-white flex justify-center mx-auto bg-blue-600 rounded-lg py-4 w-[100%]">
                                    Check Cart
                                </button>
                        </div>
                    </div>
