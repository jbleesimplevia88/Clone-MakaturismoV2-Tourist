                ...
                <div class="relative z-10 flex flex-col items-start justify-center h-fit lg:mt-[5rem] mt-[5rem] lg:ml-[6%] m-8">
                    ...
                    <form @submit.prevent="login" class=" lg:w-[40%] h-fit md:w-[40%] w-full mr-8">
                        ...
                        <div class="hidden lg:block lg:mt-10 text-center">
                            <button type="submit" class="lg:w-[8rem] w-full lg:px-4 py-2 text-white disabled:bg-blue-400 bg-blue-600 rounded-md" :disabled="!isLoginFormValid" @click="login">Login</button>
                        </div>
                        <div class="lg:hidden lg:mt-10 text-center">
                            ...
                            <button @click="openForgotModal" class="text-xs text-blue-600 mt-1">Forgot
                                    Password?</button>
                            <button @click="openPrivacyModal" class="w-full mt-8 py-2 border border-blue-400 text-blue-600 bg-white rounded-md">Sign
                                    Up</button>
                        </div>
                    </form>
                </div>
                    ...
                    <form @submit.prevent="signup" class="w-[90%] lg:px-10 px-2 lg:mt-0 mt-5">
                        ...
                        <div class="flex justify-between overflow-y-auto custom-scrollbar h-[300px] w-[100%]  p-5 mb-0">
                            <div class="flex flex-col">
                                ...
                                <p class="mb-5 text-sm text-justify">We may collect personal information from you when you interact with our website, products, or services. This information may include but is not limited to your name, email address, mailing address, phone number, and payment
                                    details. We collect this information to provide you with our services and to improve and customize your experience with us.</p>
                                <p class="font-bold mb-5">Use of Personal Information:</p>
                                <p class="mb-5 text-sm">We use the personal information we collect for various purposes, including:
                                </p>
                                <p class="mb-5 text-sm">
                                    1. Providing and personalizing our services<br> 2. Processing transactions<br> 3. Communicating with you<br> 4. Improving our products and services<br> 5. Marketing and promotional purposes<br> 6. Complying with legal obligations
                                </p>
                                <p class="font-bold mb-5">Protection of Personal Information:</p>
                                <p class="mb-5 text-sm text-justify">We take the security of your personal information seriously and have implemented appropriate measures to protect it from unauthorized access, disclosure, alteration, or destruction. However, please note that no method of transmission
                                    over the Internet or electronic storage is secure, and we cannot guarantee absolute security.
                                </p>
                                <p class="font-bold mb-5">Sharing of Personal Information:</p>
                                <p class="mb-5 text-sm text-justify">We may share your personal information with third-party service providers who assist us in providing our services, conducting our business, or servicing you. We may also share your information when required by law or to protect
                                    our rights, property, or safety.</p>
                                <p class="font-bold mb-5">Your Rights:</p>
                                <p class="mb-5 text-sm text-justify">You have the right to access, update, or delete your personal information. You may also have the right to object to or restrict certain types of processing. If you would like to exercise any of these rights, please contact
                                    us using the information provided below.</p>
                                <p class="font-bold mb-5">Changes to this Privacy Policy:</p>
                                <p class="mb-5 text-sm text-justify">We reserve the right to update or modify this Privacy Policy at any time. Any changes will be effective immediately upon posting the updated Privacy Policy on our website.</p>
                            </div>
                        </div>
                        <div>
                            ...
                            <div class="text-center mt-8">
                                <button type="submit" class="disabled:bg-blue-400 lg:w-[50%] w-full px-4 py-4 text-white bg-blue-600 rounded-md" @click="openSignUpModal" :disabled="!checkboxChecked">Continue</button>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <form @submit.prevent="signup" @input="validateForm" class="lg:w-[62%] w-fit lg:mx-[5rem] mb-8 ml-8 text-sm lg:h-full h-[55vh] font-bold hidden-scrollbar" style="overflow-y: auto;">
                        <div class="w-full grid grid-cols-1 lg:grid-cols-2">
                            ...
                            <div class="lg:flex items-center mb-3">
                                ...
                                <input id="mname" type="text" v-model="mname" placeholder="Enter Middle Initial" class="border border-gray-500 rounded-xl w-full py-3 px-3">
                            </div>
                        </div>
                        <!-- Lastname -->
                        <div class="lg:flex items-center mb-3 ">
                            ...
                            <div class="lg:flex items-center mb-3">
                                ...
                                <div class="flex flex-col w-full items-start justify-between ml-4">
                                    <div class="flex w-full">
                                        ...
                                        <input id="pnum" type="tel" v-model="pnum" placeholder="Enter Phone Number" class="border border-gray-500 rounded-r-xl lg:w-full  py-3 px-3" maxlength="10" @input="validatePhoneNumber">
                                    </div>
                        ...
                        <div class="lg:flex items-center mb-3">
                            ...
                            <div class="w-full flex flex-col items-start justify-center">
                                <div class="relative w-full">
                                    <img v-if="showCPassword" src="@/assets/images/Modal/view.png" class="absolute right-3 mx-3 my-4" style="width: 15px; cursor: pointer;" alt="Eye Icon" @click="toggleCPasswordVisibility">
                                    <img v-else src="@/assets/images/Modal/hidden.png" class="absolute  right-3 mx-3 my-4" style="width: 15px; cursor: pointer;" alt="Eye Icon" @click="toggleCPasswordVisibility">
                                    <input id="rePassword" v-model="rePassword" placeholder="Confirm Password" @input="validateRePassword" :type="showCPassword ? 'text' : 'password'" class="border border-gray-500 rounded-xl w-full py-3 px-3 ">
                                </div>
                        ...
                        <div class="lg:ml-[6rem]">
                            <div class="flex">
                                <input type="checkbox" id="myCheckbox2" class="form-checkbox h-4 w-4 text-blue-600 mr-2" v-model="checkboxChecked">
                                <p class="text-xs">
                            ...
                            <button type="submit" class="w-full lg:w-[10rem] font-bold mt-3 px-4 py-3 text-white disabled:bg-blue-400 bg-blue-600 rounded-md" :disabled="!isSignupFormValid">
                                    Sign Up
                                </button>
                        </div>
                    </form>
                ...
                <div class="relative z-10 flex flex-col items-center h-full">
                    <form @submit.prevent="signup" class="w-[85%] lg:px-10 px-2 lg:mt-0 mt-5">
                        ...
                        <div class="flex justify-between overflow-y-auto h-[280px] w-[100%] custom-scrollbar p-10">
                            <div class="flex flex-col">
                                <p class="mb-5">Welcome to <span class="font-bold">MAKATURISMO</span>, a local tourism website that connects users, businesses, advertisers, and showcases various products and services. By accessing and using this website, you agree to comply
                                    with the following terms and conditions:</p>
                                <p class="font-bold">1. Acceptance of Terms:</p>
                                <p class="ml-4 mb-5 text-sm text-justify">By using this website, you acknowledge that you have read, understood, and agree to be bound by these terms and conditions. If you do not agree with any part of these terms, please refrain from using this website.
                                </p>
                                ...
                                <p class="ml-4 text-sm text-justify">b. You are responsible for maintaining the confidentiality of your account credentials and ensuring the security of your account.
                                </p>
                                ...
                                <p class="ml-4 text-sm text-justify">a. Users must be at least 13 years old and above or have parental consent to use this website.</p>
                                ...
                                <p class="ml-4 mb-5 text-sm text-justify">c. Users must respect the intellectual property rights of others, including businesses featured on the website.</p>
                                <p class="font-bold">4. Businesses:</p>
                                <p class="ml-4 text-sm text-justify">a. Businesses must provide accurate and up-to-date information about their products and services.</p>
                                ...
                                <p class="ml-4 mb-5 text-sm text-justify">c. Businesses must comply with all applicable laws and regulations.</p>
                                ...
                                <p class="ml-4 text-sm text-justify">b. Users are solely responsible for any transactions or interactions they enter with businesses through this website.</p>
                                ...
                                <p class="ml-4 text-sm text-justify">a. All content and materials on this website, including logos, trademarks, text, images, and software, are the property of Makaturismo Tourism Website or its licensors and are protected by intellectual property laws.</p>
                                ...
                                <p class="ml-4 text-sm text-justify">We shall not be liable for any direct, indirect, incidental, consequential, or punitive damages arising from the use or inability to use the website or its content.</p>
                                ...
                                <p class="ml-4 mb-5 text-sm text-justify">b. Continued use of the website after any changes to the terms constitutes your acceptance of the revised terms.</p>
                                ...
                                <p class="ml-4 mb-5 text-sm text-justify">b. Any disputes arising from the use of this website shall be subject to the exclusive jurisdiction of the courts in the Philippines.
                                </p>
                            </div>
                        </div>
                ...
                <div class="relative z-5 flex flex-col items-start justify-center h-full lg:ml-12">
                    <form @submit.prevent="validateForm" class="lg:w-[35%] lg:mt-[10%] mt-[20%] mx-8 lg:mx-0 flex flex-col justify-between h-full">
                        <div class="mb-5">
                            ...
                            <div class="relative mb-2">
                                <div class="relative">
                                    ...
                                    <input type="text" id="otpEmail" v-model="otpEmail" @input="validateOtpEmail" class="w-full h-10 pl-10 border border-black rounded-lg" placeholder="Email">
                        ...
                        <div class="flex items-center justify-center text-center mb-[10%]">
                            <button @click="recieveotp" :disabled="!isForgotFormValid" class="lg:w-fit w-full px-4 py-2 text-white disabled:bg-blue-400 bg-blue-600 rounded-lg">Submit
                                </button>
                        </div>
                    </form>
                </div>
            ...
            <div class="relative bg-white px-5 pb-7 shadow-xl mx-auto w-full max-w-xl rounded-2xl">
                <div class="mx-auto flex w-full max-w-xl flex-col">
                    <div class="flex justify-center pt-10">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#4BAA7C" class="w-[6rem] h-[6rem]">
                    ...
                    <div class="flex flex-col items-center justify-center text-center pt-3">
                        ...
                        <div class="flex flex-row text-lg font-medium text-gray-600 pb-12">
                            <p>Thank you for registering with us using your email address! Kindly check your email address to verify your account</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <form action="" method="post">
                            <div class="flex flex-col space-y-10">
                                <div class="flex items-center justify-center lg:gap-3 gap-2">
                                    <input type="text" class="lg:w-14 w-[45px] lg:h-14 h-14 text-center text-2xl font-extrabold text-slate-900 bg-slate-100 border border-transparent hover:border-slate-200 appearance-none rounded p-4 outline-none focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
        ...
        <div v-if="showChangepass" class="fixed inset-0 z-[10] flex items-center justify-center bg-gray-800 bg-opacity-30">
            ...
            <div class="relative bg-white px-5 pb-7 shadow-xl mx-auto w-full max-w-xl rounded-2xl">
                <div class="mx-auto flex w-full max-w-xl flex-col">
                    ...
                    <div class="flex justify-center">
                        <button class="p-3 w-[92%] text-white text-xl bg-[#2969D6] rounded-lg border border-gray-500" @click="closeChangepass">
                                Okay
                            </button>
                    </div>
                </div>
    ...
    export default {
        ...
        setup(props, {
            ...
            const closeLoginSuccessModal = () => {
                ...
                close(); // Emit close event to parent component to close the modal
            };
            const closeModal = () => {
