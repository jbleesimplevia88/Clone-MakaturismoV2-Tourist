...
<template>
    <nav class="fixed top-0 z-10 w-full">
                        ...
                        <div v-if="showNotifModal" class="absolute top-[6.5rem] right-[1.2rem] bg-gray-100 shadow text-black rounded-lg w-[325px]">
                            <div class="p-4" role="none">
                                ...
                                <div class="w-full pt-30 bg-[#F2F2F2]">
                                    <div v-for="(notification, index) in bookingItems" :key="index" class="rounded-2xl p-1 flex bg-white hover:bg-blue-600 cursor-pointer w-100 mb-4" @click="openNotifModal(notification)">
                                        <!-- SVG Icon -->
                                        <svg data-v-c3ceb15a="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-2">
                    ...
                    <form @submit.prevent="signup" class="w-[85%] lg:px-10 px-2 lg:mt-0 mt-5">
                        ...
                        <div class="flex justify-between overflow-y-auto h-[290px] w-[100%] hidden-scrollbar mb-0">
                            <div class="flex flex-col">
                                ...
                                <p class="mb-5 text-sm">We use the personal information we collect for various purposes, including:</p>
                                ...
                                <p class="mb-5 text-sm text-justify">We take the security of your personal information seriously and have implemented appropriate measures to protect it from unauthorized access, disclosure, alteration, or destruction. However, please note that no method of transmission
                                    over the Internet or electronic storage is secure, and we cannot guarantee absolute security.</p>
        ...
        <div v-if="showTermsModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75">
            <div class="relative p-7 bg-white w-[90%] lg:w-[75%] lg:h-[67%] rounded-xl">
                <!-- Modal Content -->
                <div class="relative flex justify-end">
                    <button class="absolute ">
                ...
                <div class="relative z-10 flex flex-col items-center h-full">
                    <form @submit.prevent="signup" class="w-[85%] lg:px-10 px-2 lg:mt-0 mt-5">
                        ...
                        <div class="flex justify-between overflow-y-auto h-[280px] w-[100%] hidden-scrollbar mb-10">
                            <div class="flex flex-col">
                                ...
                                <p class="ml-4 mb-5 text-sm text-justify">b. Any disputes arising from the use of this website shall be subject to the exclusive jurisdiction of the courts in the Philippines.</p>
                            </div>
                        </div>
                        ...
                        <form action="" method="post">
                            <div class="flex flex-col space-y-10">
                                <div class="flex items-center justify-center gap-3">
                                    <input type="text" class="w-14 h-14 text-center text-2xl font-extrabold text-slate-900 bg-slate-100 border border-transparent hover:border-slate-200 appearance-none rounded p-4 outline-none focus:bg-white focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
