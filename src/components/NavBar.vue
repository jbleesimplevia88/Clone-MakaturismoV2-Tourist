          ...
          <form @submit.prevent="signup" class="w-[85%] lg:px-10 px-2 lg:mt-0 mt-5">
            ...
            <div class="flex justify-between overflow-y-auto h-[230px] w-[100%] hidden-scrollbar mb-2">
              <div class="flex flex-col">
                ...
                <p class="mb-5 text-sm text-justify">We may collect personal information from you when you interact with
                  our website,
                ...
                <p class="mb-5 text-sm text-justify">We reserve the right to update or modify this Privacy Policy at any
                  time. Any changes
    ...
    <div v-if="showSignUpModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75">
      <div class="relative pr-8 pt-8 bg-white lg:w-3/4 w-11/12 lg:h-3/4 h-[75%] rounded-xl">
        ...
        <div class="relative z-10 flex flex-col items-start justify-center lg:h-full">
          <form @submit.prevent="signup" class="lg:w-[62%] lg:mx-[5rem] mb-8 ml-8 text-sm lg:h-full h-[55vh] font-bold"
            ...
            <div class="w-full grid grid-cols-1 lg:grid-cols-2">
              ...
              <div class="lg:flex items-center mb-3">
                ...
                <input id="username" type="text" v-model="username" placeholder="Enter First Name"
            ...
            <div class="w-full grid grid-cols-1 lg:grid-cols-2 ">
              ...
              <div class="lg:flex items-center mb-3">
                ...
                <input id="pnum" type="text" v-model="pnum" placeholder="Enter Phone Number"
                  class="border border-gray-500 rounded-xl w-full py-3 px-3">
              </div>
            </div>
            <div class="w-full grid lg:grid-cols-2 gap-2">
              ...
              <div class="lg:flex items-center mb-3">
                ...
                <input id="citizenship" type="text" v-model="citizenship" placeholder="Citizenship"
                  class="border border-gray-500 rounded-xl w-full py-3 px-3">
              </div>
              <!-- Gender -->
              <div class="lg:flex items-center mb-3">
            ...
            <div class="lg:flex items-center mb-3">
              ...
              <input id="rePassword" type="text" v-model="rePassword" placeholder="Confirm Password"
                class="border border-gray-500 rounded-xl w-full py-3 px-3">
            </div>
            <div class="lg:ml-[6rem]">
              ...
              <button type="submit"
                class="w-full lg:w-[10rem] font-bold mt-3 px-4 py-3 text-white bg-blue-600 rounded-md">Sign Up</button>
            ...
            <div class="flex justify-between overflow-y-auto h-[230px] w-[100%] hidden-scrollbar mb-2">
              <div class="flex flex-col">
                <p class=" mb-5">Welcome to <span class="font-bold">MAKATURISMO</span>, a local tourism website that
                  connects users, businesses, advertisers, and showcases various products and services. By accessing and
                ...
                <p class="ml-4 text-sm text-justify">a. To access certain features on the website, you may be required
                  ...
                  process.</p>
                <p class="ml-4 text-sm text-justify">b. You are responsible for maintaining the confidentiality of your
                ...
                <p class="ml-4 text-sm text-justify">a. Users must be at least 18 years old or have parental consent to
                  use this website.</p>
                ...
                <p class="ml-4 text-sm text-justify">a. Businesses and advertisers must provide accurate and up-to-date
                  information about their products and services.</p>
                <p class="ml-4 text-sm text-justify">b. We reserve the right to approve or reject business listings and
                  advertisements based on our guidelines and policies.</p>
                <p class="ml-4 mb-5 text-sm text-justify">c. Businesses and advertisers must comply with all applicable
                ...
                <p class="ml-4 text-sm text-justify">a. Users may submit content to the website, such as reviews,
                  ...
                  the website. </p>
                <p class="ml-4 mb-5 text-sm text-justify">b. Users must not submit content that is unlawful, defamatory,
                ...
                <p class="ml-4 text-sm text-justify">a. The website and its content are provided "as is" without any
                  warranties, express or implied. We do not guarantee the accuracy, completeness, or reliability of the
                  information provided. </p>
                <p class="ml-4 mb-5 text-sm text-justify">b. We shall not be liable for any direct, indirect,
                  incidental, consequential, or punitive damages arising from the use or inability to use the website or
                  its content</p>
                ...
                <p class="ml-4 mb-5 text-sm text-justify">b. Continue use of the website after any changes to the terms
                  constitutes your acceptance of the revised terms</p>

                <p class="font-bold ">10. Governing Law and Jurisdiction</p>
                <p class="ml-4 text-sm text-justify">a. These terms and conditions shall be governed by and construed in
