...
<nav class="fixed top-0 z-10 w-full">
        ...
        <div class="flex items-center space-x-4">
            ...
            <div class=" hidden lg:block relative  " ref="searchContainer">
                ...
                <span @click="toggleInputVisibility" class="flex items-center whitespace-nowrap px-3 py-[0.25rem] text-surface [&>svg]:h-5 [&>svg]:w-5" id="button-addon2">
                    ...
                    <svg class="" v-show="!showInput" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                    </svg>
                </span>
            </div>
                    ...
                    <div v-if="showNotifModal" class="absolute top-[6.5rem] right-[1.2rem] bg-gray-100 shadow text-black rounded-lg w-[325px]">
                        <div class="p-4" role="none">
                            ...
                            <div class="w-full pt-30 bg-[#F2F2F2]">
                              <div v-for="(notification, index) in bookingItems" :key="index" class="rounded-2xl p-1 flex bg-white hover:bg-gray-600 hover:bg-blue-500 cursor-pointer w-100 mb-4" @click="openNotifModal(notification)">

                                    <!-- SVG Icon -->
                                    <svg data-v-c3ceb15a="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-2">
                                        <path data-v-c3ceb15a="" fill-rule="evenodd" d="M5.25 9a6.75 6.75 0 0 1 13.5 0v.75c0 2.123.8 4.057 2.118 5.52a.75.75 0 0 1-.297 1.206c-1.544.57-3.16.99-4.831 1.243a3.75 3.75 0 1 1-7.48 0 24.585 24.585 0 0 1-4.831-1.244.75.75 0 0 1-.298-1.205A8.217 8.217 0 0 0 5.25 9.75V9Zm4.502 8.9a2.25 2.25 0 1 0 4.496 0 25.057 25.057 0 0 1-4.496 0Z" clip-rule="evenodd"></path>
                                    </svg>
            ...
            <div v-else>
                <div class="hidden lg:flex items-center space-x-4">
                    ...
                    <a class="hidden lg:block lg:bg-blue-500 lg:hover:bg-blue-700 lg:text-white lg:font-bold lg:py-2 lg:px-4 lg:border lg:border-blue-700 lg:rounded-lg" href="#">Become a partner</a>
                </div>
            </div>
        ...
        <div class="relative p-7 bg-white w-[90%] lg:w-[75%] lg:h-[70%] rounded-xl">
            ...
            <div class="relative flex justify-end">
                <button class="absolute ">
                    <svg @click="closeOTP" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="5" stroke="black" class="w-auto h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6 18 18 6M6 6l12 12" />
                    </svg>
                </button>
            </div>
                ...
                <div v-if="passwordPolicy.length > 0" class="text-red-500 text-xs">
                  <ul>
                    ...
                    <div class="lg:ml-[6rem]">
                        ...
                        <button type="submit" class="w-full lg:w-[10rem] font-bold mt-3 px-4 py-3 text-white disabled:bg-blue-400 bg-blue-600 rounded-md" :disabled="!isSignupFormValid" @click="signup">Sign Up</button>
                    </div>
                </form>
            </div>
        </div>
          ...
          <button @click="openSignUpModal" class="text-blue-600">
            ...
            <div class="relative z-10 flex flex-col items-center h-full">
                <form @submit.prevent="signup" class="w-[85%] lg:px-10 px-2 lg:mt-0 mt-5">
                    ...
                    <div class="flex justify-between overflow-y-auto h-[230px] w-[100%] hidden-scrollbar mb-2">
                        <div class="flex flex-col">
                            <p class=" mb-5">Welcome to <span class="font-bold">MAKATURISMO</span>, a local tourism website that
                                connects users, businesses, advertisers, and showcases various products and services. By accessing
                                and
                            ...
                            <p class="ml-4 mb-5 text-sm text-justify">By using this website, you acknowledge that you have read,
                            ...
                            <p class="ml-4 text-sm text-justify">a. To access certain features on the website, you may be required
                                to create a user account. You must provide accurate and complete information during the registration
                                process.</p>
                            <p class="ml-4 text-sm text-justify">b. You are responsible for maintaining the confidentiality of
                                your
                                account credentials and ensuring the security of your account.</p>
                            <p class="ml-4 mb-5 text-sm text-justify">c. You are solely responsible for all activities conducted
                                through your account, and you must notify us immediately of any unauthorized use or security breach.
                            </p>

                            <p class="font-bold ">3. User Responsibilities:</p>
                            <p class="ml-4 text-sm text-justify">a. Users must be at least 18 years old or have parental consent
                                to
                                use this website.</p>
                            <p class="ml-4 text-sm text-justify">b.Users shall not engage in any illegal, abusive, defamatory, or
                                harmful activities while using the website.</p>
                            <p class="ml-4 mb-5 text-sm text-justify">c. Users must respect the intellectual property rights of
                            ...
                            <p class="ml-4 text-sm text-justify">b. We reserve the right to approve or reject business listings
                                and
                            ...
                            <p class="ml-4 text-sm text-justify">a. The website may feature products and services from various
                            ...
                            <p class="ml-4 mb-5 text-sm text-justify">c. We are not liable for any losses, damages, or disputes
                                arising from transactions between users and businesses.</p>

                            <p class="font-bold ">6. Content Submission:</p>
                            <p class="ml-4 text-sm text-justify">a. Users may submit content to the website, such as reviews,
                                comments, or images. By doing so, you grant us the right to use, modify, and display the content on
                                the website. </p>
                            ...
                            <p class="ml-4 text-sm text-justify">a. All content and materials on this website, including logos,
                                trademarks, text, images, and software, are the property of Love Laguna or its licensors and are
                                protected by intellectual property laws. </p>
                            <p class="ml-4 mb-5 text-sm text-justify">b. Users must not use, reproduce, or distribute any content
                                from this website without obtaining proper authorization.</p>

                            <p class="font-bold ">8. Disclaimer of Liability</p>
                            <p class="ml-4 text-sm text-justify">a. The website and its content are provided "as is" without any
                                warranties, express or implied. We do not guarantee the accuracy, completeness, or reliability of
                                the
                                information provided. </p>
                            <p class="ml-4 mb-5 text-sm text-justify">b. We shall not be liable for any direct, indirect,
                                incidental, consequential, or punitive damages arising from the use or inability to use the website
                                or
                                its content</p>

                            <p class="font-bold ">9. Modification and Termination</p>
                            <p class="ml-4 text-sm text-justify">a. We reserve the right to modify or terminate the website and
                                these terms and conditions at any time without prior notice </p>
                            <p class="ml-4 mb-5 text-sm text-justify">b. Continue use of the website after any changes to the
                                terms
                                constitutes your acceptance of the revised terms</p>

                            <p class="font-bold ">10. Governing Law and Jurisdiction</p>
                            <p class="ml-4 text-sm text-justify">a. These terms and conditions shall be governed by and construed
                                in
                                accordance with the laws of the Philippines </p>
                            <p class="ml-4 mb-5 text-sm text-justify">b. Any disputes arising from the use of the website shall be
                ...
                <form @submit.prevent="validateForm" class="lg:w-[35%] lg:mt-[10%] mt-[20%] mx-8 lg:mx-0 flex flex-col justify-between h-full">
                    <div class="mb-5">
                        <div class="flex items-center mb-12 w-[50%]">
                            <button @click="openLoginModal" class="hidden text-blue-600"><img src="@/assets/images/Modal/back.png" style="width: 20px; height: 20px;" alt="" class="my-2 mr-2"></button>
                    ...
                    <div class="flex items-center justify-center text-center mb-[10%]">
                        <button @click="openOTPModal" :disabled="!isForgotFormValid" class="lg:w-fit w-full px-4 py-2 text-white disabled:bg-blue-400 bg-blue-600 rounded-lg">Receive OTP
                        </button>
                        ...
                        <div class="flex flex-col space-y-10">
                            <div class="flex flex-row items-center justify-center lg:gap-5 mx-auto w-full max-w-md">
                                <div class="w-[3rem] h-[5rem] outline outline-2 ">
                                    <input class=" w-full h-full flex flex-col items-center justify-center text-center outline-none border border-gray-200 text-3xl bg-white focus:bg-gray-50 focus:ring-1 ring-blue-700" type="text" name="" id="" placeholder="*">
                                </div>
                                <div class="w-[3rem] h-[5rem] outline outline-2">
                                    <input class="w-full h-full flex flex-col items-center justify-center text-center outline-none border border-gray-200 text-3xl bg-white focus:bg-gray-50 focus:ring-1 ring-blue-700" type="text" name="" id="" placeholder="*">
                                </div>
                                ...
                                <div class="w-[3rem] h-[5rem] outline outline-2">
                                    <input class="w-full h-full flex flex-col items-center justify-center text-center outline-none rounded-xl border border-gray-200 text-3xl bg-white focus:bg-gray-50 focus:ring-1 ring-blue-700" type="text" name="" id="" placeholder="*">
                                </div>
                            </div>

                            <div class="flex flex-col space-y-2 items-center justify-center w-full">
                                <button class=" text-center lg:w-[24rem] w-full rounded-xl py-3 bg-blue-700 text-white" @click="closeOTP">
                                    Verify
                                </button>

                                <div class="flex flex-row items-center justify-center text-center text-sm text-black">
                                    <p>Didn't receive code?</p> <a class="flex flex-row items-center font-medium text-blue-600" href="http://" target="_blank" rel="noopener noreferrer">Resend code</a>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    <div v-if="isCategoryPath($route.path)" class="hidden lg:inset-x-0 lg:bottom-0 lg:grid lg:grid-cols-6 lg:pl-10 lg:pr-10 lg:pt-2 lg:pb-2 lg:justify-center lg:text-black lg:bg-white lg:border-t max-w-full">
        <!-- Location 1 -->
