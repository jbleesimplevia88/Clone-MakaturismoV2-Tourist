<template>
  <div class="relative pt-[57px] md:pt-[80px]">
    <div class="relative">
      ...
      <div class="relative sm:absolute inset-0 sm:top-56 md:top-80 flex text-center lg:text-left justify-center items-center z-[1]">
  ...
  <div class="cotainer mx-auto px-3 lg:px-32 pb-5 pt-5" style="background-color: #102E61;">
    <div>
      <div class="pb-10">
        <!-- Filter dropdown -->
            ...
            <div role="menu" aria-orientation="horizontal" aria-labelledby="options-menu">
              ...
              <div class="grid grid-cols-3 grid-row-3 mt-5">
                  ...
                  <div class="grid grid-rows-8 grid-flow-col gap-4 ml-4 p-2">
                    <div v-for="(category, index) in categories" :key="'category-' + index">
                      <label :for="'categoryCheckbox-' + index" class="flex items-center">
                        <input class="accent-[#102E61]" type="checkbox" :id="'categoryCheckbox-' + index"
                ...
                <div class="col-span-2 px-2">
                  <div class="grid grid-rows-12 grid-flow-row-dense lg:grid-rows-8 md:grid-flow-col gap-4 mr-4 p-2">
      ...
      <div class="grid grid-cols-2">
        <div class="flex justify-start items-center">
          <p class="text-center text-white">Showing <span class="text-[#29BFD6]">{{ paginationStartIndex }} - {{
            paginationEndIndex }}</span> results from <span class="text-[#29BFD6]">{{ totalRecords }}</span> records
          </p>
        </div>
