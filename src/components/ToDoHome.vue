<template>
    <div class="relative pt-[57px] md:pt-[80px]">
        <div class="relative">
            <div class="absolute top-100 left-0 h-[101%] w-[100%]" style="background: linear-gradient(to left, transparent, #102E61 96%, #102E61 70%);">
            </div>
            <div class="absolute top-0 left-0 h-[101%] w-[100%]" style="background: linear-gradient(to bottom, transparent 75%, #102E61 87%, #102E61 40%);">
            </div>
            ...
            <div class="relative sm:absolute inset-0 sm:top-56 md:top-[23rem] flex text-center lg:text-left justify-center items-center z-[1]">
                <p class="pt-[6rem] text-[17px] sm:text-sm md:text-xl md:pt-[2rem] lg:text-[1.7rem] text-wrap leading lg:leading-10 text-white">
        ...
        <div>
            ...
            <div class="pb-10 hidden lg:block">
                <div class="relative text-left" @click.stop ref="webDropdown">
                    ...
                    <!-- Dropdown menu -->
                    <div v-if="showDropdown" class="z-[1] origin-top-left relative md:absolute left-0 mt-2 w-[400px] md:w-[868px] lg:w-[1150px] rounded-2xl shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <div role="menu" aria-orientation="horizontal" aria-labelledby="options-menu" @click.stop>
                            ...
                            <div class="grid grid-cols-3 grid-row-3 mt-5">
                                <div class="relative px-2 w-[85%] -mt-2">
                                    <div class="absolute" style="border-right: 1px solid #0000004D; top: 15%; bottom: 15%; right: 0;">
                                    </div>
