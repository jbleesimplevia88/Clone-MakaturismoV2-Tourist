<template>
  ...
  import landingPageImage1 from '@/assets/images/CategoryView/ToEat/eat.png';
  import landingPageImage2 from '@/assets/images/CategoryView/ToEat/eat6.png';
  import landingPageImage3 from '@/assets/images/CategoryView/ToEat/eat7.png';
