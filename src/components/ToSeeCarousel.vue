<template>
  ...
  import landingPageImage1 from '@/assets/images/CategoryView/ToSee/glo.png';
  import landingPageImage2 from '@/assets/images/CategoryView/ToSee/glo2.png';
  import landingPageImage3 from '@/assets/images/CategoryView/ToSee/glo3.png';
