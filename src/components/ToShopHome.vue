                        ...
                        <div role="menu" aria-orientation="horizontal" aria-labelledby="options-menu">
                            ...
                            <div class="grid grid-cols-3 grid-row-3 mt-5">
                                <div class="relative px-2">
                                    <div class="absolute"
                                        style="border-right: 1px solid #0000004D; top: 15%; bottom: 15%; right: 0;"></div>
                                    <div class="grid grid-rows-8 grid-flow-col gap-3 ml-4 p-2">
                                        <div v-for="(category, index) in categories" :key="'category-' + index">
                                            <label :for="'categoryRadio'" class="flex items-center">
                                                <input type="radio" :id="'categoryRadio'" :value="category"
                                ...
                                <div class="col-span-2 px-2">
                                    <div
                                        class="grid grid-rows-12 grid-flow-row-dense lg:grid-rows-8 md:grid-flow-col gap-2 mr-4 p-2">
                                        <div v-for="(location, index) in locations" :key="'location-' + index">
                                            <label :for="'locationRadio'" class="flex items-left">
                                                <input type="radio" :id="'locationRadio'" :value="location"
                                                ...
                                                <div class="relative px-2">
                                                    ...
                                                    <div class="grid gap-4 ml-4 p-2 grid-cols-2">
                                                        <div v-for="(category, index) in categories"
                                                            :key="'category-' + index">
                                                            <label :for="'categoryCheckbox-' + index"
                                                    ...
                                                    <div class="grid grid-cols-2 border-b-2 p-3 font-bold ml-5 mr-5">
                                                        <div>
                                                            <h2 class="mb-2 ml-1 whitespace-nowrap"
                                                                style="font-size: 15px;">Explored by area</h2>
                                                        </div>
