<template>
    <div class="relative pt-[57px] md:pt-[80px]">
        <div class="relative">
            ...
            <img v-if="toshopData" :src="getImageUrl(toshopData.backgroundphotophoto)" class="w-full h-[300px]  md:h-[700px]" alt="To Do Image" />
            ...
            <div class="relative sm:absolute inset-0 sm:top-4 md:top-[23rem] flex text-center lg:text-left justify-center items-center z-[1]">
                <p class="pt-[6rem] text-[17px] sm:text-sm md:text-xl lg:text-[1.7rem] px-0 lg:px-[8rem] text-wrap leading lg:leading-10 text-white">
                    {{ toshopData ? toshopData.description : 'Loading...' }}
                </p>
            </div>.
        </div>
    </div>
