    ...
    <div class="relative pt-[57px] md:pt-[80px]">
        <div class="relative">
            ...
            <div
                ...
                <p
                    class="pt-[1.5rem] lg:pt-[6rem] pb-6 text-[14px] sm:text-sm md:text-xl lg:text-[1.7rem]  px-0 lg:px-[8rem] text-wrap leading lg:leading-10 text-white">
    ...
    methods: {
        ...
        seeMore(item) {
            ...
            if (latitude !== null && longitude !== null) {
                this.$router.push({ name: 'central', query: { latitude, longitude, name: item.name } });
            } else {
